...
@push('styles')
    <link
        rel="stylesheet"
        href="{{ asset('css/weather-map.css') }}?v={{ file_exists(public_path('css/weather-map.css')) ? filemtime(public_path('css/weather-map.css')) : time() }}"
    >
@endpush
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-clean metric-card h-100">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="metric-value" id="metric-total">{{ $weatherList->count() }}</div>
...
@push('scripts')
    <script>
        window.weatherDataset = @json($weatherList);
    </script>
    <script src="{{ asset('js/weather-map.js') }}?v={{ file_exists(public_path('js/weather-map.js')) ? filemtime(public_path('js/weather-map.js')) : time() }}"></script>
@endpush
