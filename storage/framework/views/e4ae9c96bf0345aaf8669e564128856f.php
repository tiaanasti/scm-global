...
<div class="port-page">
    ...
    <div class="content">
        ...
        <div class="card-clean mb-4">
            <div class="section-title mb-3">Tracking Rute Pelabuhan</div>

            <div class="row g-3 align-items-end">
                <div class="col-xl-4 col-lg-5">
                    <label for="originPort" class="form-label fw-semibold">
                        Pelabuhan Asal
                    </label>
                ...
                <div class="col-xl-4 col-lg-5">
                    <label for="destinationPort" class="form-label fw-semibold">
                        Pelabuhan Tujuan
                    </label>

                    <select id="destinationPort" class="form-select">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                        <div>
                            ...
                            <div class="metric-sub">
                                Dua marker biru dihubungkan garis merah putus-putus.
                            </div>
                        </div>
                    ...
                    <div class="row g-3 mt-1">
                        ...
                        <div class="col-lg-4">
                            <div class="route-summary-card h-100">
                                ...
                                <strong id="destinationInfo">-</strong>
                            </div>
                        </div>

                        <div class="col-lg-4">
                            <div class="route-summary-card route-distance-card h-100">
                                <small>Jarak Garis Lurus</small>
                                <strong id="distanceInfo">- km</strong>
                            </div>
                        </div>
                    </div>

                    <div class="port-map-note">
                        Garis merah putus-putus menunjukkan hubungan langsung antar-pelabuhan.
                        Titik merah bergerak merupakan simulasi tracking, bukan posisi kapal secara real-time.
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3">
                <div class="card-clean h-100">
                    ...
                    <div class="recommendation-box mt-4">
                        ...
                        <div class="mt-2">
                            Pilih pelabuhan asal dan tujuan untuk melihat koneksi rute pada peta.
                            Data pelabuhan lengkap tersedia pada tabel di bawah.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-clean">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
                <div>
                    ...
                    <div class="metric-sub">
                        Data nama, kota, negara, koordinat, status, dan risiko pelabuhan.
                    </div>
                </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $ports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $port): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            ...
                            $statusClass = $statusGroup === 'safe'
                                ? 'risk-low'
                                : ($statusGroup === 'warning' ? 'risk-medium' : 'risk-high');
