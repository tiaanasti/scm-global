                ...
                <div class="card-clean metric-card h-100">
                    ...
                    <div>
                        ...
                        <div class="metric-value">
                            <?php echo e(number_format($newsItems->count())); ?>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-clean metric-card h-100">
                    ...
                    <div>
                        ...
                        <div class="metric-value">
                            <?php echo e(number_format($positivePercentage, 1)); ?>%
                        </div>

                        <div class="metric-sub">
                            <?php echo e(number_format($positiveCount)); ?> berita
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-clean metric-card h-100">
                    ...
                    <div>
                        ...
                        <div class="metric-value">
                            <?php echo e(number_format($neutralPercentage, 1)); ?>%
                        </div>

                        <div class="metric-sub">
                            <?php echo e(number_format($neutralCount)); ?> berita
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-clean metric-card h-100">
                    ...
                    <div>
                        ...
                        <div class="metric-value">
                            <?php echo e(number_format($negativePercentage, 1)); ?>%
                        </div>

                        <div class="metric-sub">
                            <?php echo e(number_format($negativeCount)); ?> berita
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-5">
                <div class="card-clean h-100">
                    <div class="section-title">
                        Ringkasan Sentimen <?php echo e($country->name ?? '-'); ?>

                    </div>

                    <?php if($newsItems->isNotEmpty()): ?>
                ...
                <div class="card-clean news-panel">
                    <div class="d-flex justify-content-between align-items-center gap-3 mb-3">
                        <div class="section-title mb-0">
                            Berita <?php echo e($country->name ?? '-'); ?>

                        </div>

                        <span class="risk-badge risk-low">
                            <?php echo e($newsItems->count()); ?> berita
                        </span>
                    </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $newsItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <article class="news-item">
                                <div class="d-flex align-items-center gap-2 flex-wrap mb-2">
                                    <span
                                        class="risk-badge <?php echo e($sentimentClass($item->sentiment ?? null)); ?>"
                                    >
                                ...
                                <div class="news-meta mt-2">
                                    ...
                                    <span>
                                        Positif:
                                        <?php echo e((int) ($item->positive_score ?? 0)); ?>

                                    </span>

                                    <span>
                                        Negatif:
                                        <?php echo e((int) ($item->negative_score ?? 0)); ?>
                ...
                <div class="card-clean news-panel">
                    ...
                    <div class="table-responsive news-table-wrap">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $allNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <strong>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const positivePercentage =
            Number(<?php echo json_encode($positivePercentage, 15, 512) ?>);

        const neutralPercentage =
            Number(<?php echo json_encode($neutralPercentage, 15, 512) ?>);

        const negativePercentage =
            Number(<?php echo json_encode($negativePercentage, 15, 512) ?>);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\supply-chain-management\resources\views\news\index.blade.php ENDPATH**/ ?>